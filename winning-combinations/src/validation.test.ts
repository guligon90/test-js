import { checkPayingSequencesOnLine, performSequentialAnalysisOnArray } from "./validation";
...
test.each([
  ...
  [[1, 1, 2, 0, 0], [[2, [2, 3, 4]]]],
  [[11, 0, 0, 7, 4], [[7, [1, 2, 3]]]],
])(`${performSequentialAnalysisOnArray.name} - when line is %j returns %j`, (line, expected) => {
	const received = checkPayingSequencesOnLine(line);
